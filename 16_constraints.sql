...
(2, 'user02', 'pass02', '유관순', '여', '010-6789-0123', 'yu123@gmail.com');

select * from user_notnull;

-- not null 로 설정한  user_pwd null 넣어보기
insert into user_notnull
(user_no, user_id, user_pwd, user_name, gender, phone, email)
values
...
-- 한 테이블 단 1 개만 설정이 가능하다. 
-- 컬럼 레벨, 테이블 레벨 둘 다 설정이 가능하다. 
...
values
(3, 'user03', 'pass03', '유관순1', '여', '010-6789-0123', 'yu123@gmail.com',10),
(4, 'user04', 'pass04', '유관순2', '여', '010-6789-0123', 'yu123@gmail.com',20);
...
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
values
(5, 'user05', 'pass05', '유관순3', '여', '010-6789-0123', 'yu123@gmail.com', 50);
...
-- default 설정이 되어 있는 컬럼들에 default 값이 들어갈 수 있도록 한다. 
